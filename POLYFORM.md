MODIFIED TO ACCOMODATE POLYSPLIT.

# Polyform Strict License (MODIFIED)
...
## Important
ALL CODE PERTAINING TO POLYSPLIT IS CURRENTLY UNDER THE POLYFORM STRICT LICENSE. POLYTORIA-SPECIFIC CODE IS UNDER THE MPL 2.0.
YOU CANNOT MAKE CUSTOM CLIENTS WITH THIS REPO, BUT YOU'RE ALLOWED TO ON THE **MAIN POLYTORIA REPO**.
